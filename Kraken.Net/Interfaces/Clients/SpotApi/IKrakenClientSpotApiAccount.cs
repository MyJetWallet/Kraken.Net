...
namespace Kraken.Net.Interfaces.Clients.SpotApi
{
    ...
    public interface IKrakenClientSpotApiAccount
    {
        ...
        Task<WebCallResult<KrakenLedgerPage>> GetLedgerInfoAsync(IEnumerable<string>? assets = null, IEnumerable<LedgerEntryType>? entryTypes = null, DateTime? startTime = null, DateTime? endTime = null, string startId = null, string endId = null, int? resultOffset = null, string? twoFactorPassword = null, CancellationToken ct = default);
